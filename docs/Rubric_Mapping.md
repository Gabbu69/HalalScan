...
| 4 | Reasoning Engine | 15% | Deterministic product priority `HARAM > HALAL`; response still exposes ingredient-level doubtful/unknown facts, matched rules, certification check, conflict resolution, and logic path. The Analysis page labels this explicitly under Reasoning Engine. | 14/15 |
...
- Emphasize the 67-rule canonical KB and explainable conflict resolution.
